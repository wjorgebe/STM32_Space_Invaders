...
#define A14    ((13.75   * NUM/RATE) * (1<<16)) /* A0 */
#define A27    ((27.5    * NUM/RATE) * (1<<16)) /* A1 */
#define A55    ((55.0    * NUM/RATE) * (1<<16)) /* A2 */
#define A110   ((110.0   * NUM/RATE) * (1<<16)) /* A3 */
#define A220   ((220.0   * NUM/RATE) * (1<<16)) /* A4 */
#define A440   ((440.0   * NUM/RATE) * (1<<16)) /* A5 */
#define A880   ((880.0   * NUM/RATE) * (1<<16)) /* A6 */
#define A1760  ((1760.0  * NUM/RATE) * (1<<16)) /* A7 */
#define A3520  ((3520.0  * NUM/RATE) * (1<<16)) /* A8 */
#define A7040  ((7040.0  * NUM/RATE) * (1<<16)) /* A9 */
#define A14080 ((14080.0 * NUM/RATE) * (1<<16)) /* A10 */
